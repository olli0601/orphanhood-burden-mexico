# =============================================================================
# ch4_190_gam_verify_nowcast_logic.R  ·  Chapter 4 — Delay-adjusted nowcasting
# Verify internal nowcast logic (stacking, indexing) against expectations.
# Reads input-data-processed/stacked_births_data_2016_2023.RDS -> checks.
# =============================================================================
...
stacked_data <- readRDS("input-data-processed/stacked_births_data_2016_2023.RDS")
