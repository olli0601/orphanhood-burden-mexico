# =============================================================================
# ch4_240_gam_nowcast_new.R  ·  Chapter 4 — Delay-adjusted nowcasting
# Updated GAM nowcast variant (revised specification).
# Reads input-data-processed/{births_grouped_mun,population_grouped_mun,rural_urban_area}.* -> models/predictions.
# =============================================================================
