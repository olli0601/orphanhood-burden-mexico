# =============================================================================
# ch4_050_nowcast_run_model.R  ·  Chapter 4 — Delay-adjusted nowcasting
# Fit the nowcast model on the prepared triangle and save posterior draws.
# Reads input-data-processed/{z_tsd,years,groups,delays}.rds (sources ch4_040) -> writes input-data-processed/posterior_samples.rds.
# =============================================================================

library(nimble)

# Load data
z_tsd <- readRDS("input-data-processed/z_tsd.rds")
years <- readRDS("input-data-processed/years.rds")
regions <- readRDS("input-data-processed/groups.rds")
delays <- readRDS("input-data-processed/delays.rds")
...
# Load model code
source("ch4_040_nowcast_model_code.R")
...
saveRDS(samples, "input-data-processed/posterior_samples.rds")
