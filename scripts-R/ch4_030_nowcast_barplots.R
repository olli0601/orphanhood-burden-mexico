# =============================================================================
# ch4_030_nowcast_barplots.R  ·  Chapter 4 — Delay-adjusted nowcasting
# Registered vs nowcasted birth barplots (national/by-sex) for 2016-2023.
# Reads input-data-processed/{municipality_models_proper_validation,births_grouped_mun,population_grouped_mun}.RDS -> writes nowcast_{predictions,births_yearly,summary}_2016_2023 + stacked_births_data_2016_2023 RDS + output/ch4/nowcast_*.png (Figs 12/13). birth_data_all assembly split to ch4_050.
# =============================================================================
