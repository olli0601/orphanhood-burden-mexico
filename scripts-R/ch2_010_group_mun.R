...
# ~519 analytical units. Uses the helper R/ch2_agg_municipality.R.
#
...
saveRDS(new_mun, file = "input-data-processed/grouped_municipality_30000.RDS")
...
saveRDS(new_mun_50000, file = "input-data-processed/grouped_municipality_50000.RDS")
