# =============================================================================
# ch4_060_nowcast_evaluate_performance.R  ·  Chapter 4 — Delay-adjusted nowcasting
# Evaluate nowcast predictive performance against held-out registrations.
# Reads input-data-processed/{posterior_samples,years,groups,test_df}.rds -> performance metrics.
# =============================================================================
...
test_df <- readRDS("input-data-processed/test_df.rds") |>
