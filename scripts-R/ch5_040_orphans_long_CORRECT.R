...
# =============================================================================
saveRDS(fertility_df, "input-data-processed/fertility_df.RDS")
saveRDS(survival_df, "input-data-processed/survival_df.RDS")

fertility_df <- readRDS("input-data-processed/fertility_df.RDS")
survival_df <- readRDS("input-data-processed/survival_df.RDS")
...
# ──────────────────────────────────────────────────────────────
aggregated_muni <- readRDS(file = "input-data-processed/aggregated_muni_50000.RDS")
...
# Read your RDS
x <- readRDS(file = "input-data-processed/aggregated_muni_50000.RDS")
...
# Save if desired
# write_csv(corr_tbl, "output/ch5/spearman_correlations_municipal.csv")
...
# Save if desired
# write_csv(globals, "output/ch5/global_morans_i.csv")
...
# st_write(muni, "output/ch5/lisa_orphan_rate.gpkg", delete_dsn = TRUE)
