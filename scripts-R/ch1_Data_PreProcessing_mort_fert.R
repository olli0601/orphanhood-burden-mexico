...
#-------------------------------------------------------------------------------
# Read the data
deaths_data <- read_csv("../datasets/mortality_mexico.csv")
...
# Read the data
fertility_data <- read_csv("../datasets/fertility_mexico.csv")
...
##------------------------------- Poverty rate -------------------------------
mpi <- read_excel("../datasets/IMM_2020.xls", sheet = "IMM_2020")
mpi <- mpi %>%
