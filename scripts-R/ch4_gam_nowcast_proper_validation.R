...
if(nrow(validation_predictions) > 0) {
  ...
  ggsave("validation_performance_improved.png", p1, width = 10, height = 8, dpi = 300, bg = "white")
...
if(nrow(test_predictions) > 0) {
  ...
  ggsave("test_performance_improved.png", p2, width = 10, height = 8, dpi = 300, bg = "white")
...
ggsave("beta_distributions_improved.png", p3, width = 10, height = 8, dpi = 300, bg = "white")
...
ggsave("fertility_curves_shifts_improved.png", p4, width = 12, height = 8, dpi = 300, bg = "white")
...
# Save all results
saveRDS(all_results_train, "municipality_models_proper_validation.RDS")
saveRDS(results_summary_train, "municipality_models_summary_proper_validation.RDS")

if(exists("validation_predictions") && nrow(validation_predictions) > 0) {
  saveRDS(validation_predictions, "validation_predictions.RDS")
  saveRDS(validation_metrics, "validation_metrics.RDS")
}

if(exists("test_predictions") && nrow(test_predictions) > 0) {
  saveRDS(test_predictions, "test_predictions.RDS") 
