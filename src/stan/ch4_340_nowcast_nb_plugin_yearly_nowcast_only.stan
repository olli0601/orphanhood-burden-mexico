// =============================================================================
// ch4_340_nowcast_nb_plugin_yearly_nowcast_only.stan  ·  Chapter 4
// Stan model: Negative-Binomial plug-in yearly birth nowcast (nowcast-only).
// Reported-by-today counts with a completeness (delay) offset; NB head absorbs
// overdispersion. Compiled via cmdstanr by the Chapter 4 runners.
// =============================================================================
