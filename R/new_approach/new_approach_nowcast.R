...
pop_path    <- "population_new_mun.RDS"
births_path <- "births_new_mun.RDS"
...
if (nrow(sel) == 0) {
  ...
  saveRDS(list(fit = fit,
          ...
          "nowcast_bayes_yearly_NOWCAST_ONLY_outputs.rds")
  quit(save = "no")
}
...
print(p_nat)
ggsave("nowcast_yearly_barplot_NATIONAL.png", p_nat, width = 11, height = 7, dpi = 300)
...
print(p_nat_full)
ggsave("nowcast_yearly_barplot_NATIONAL_1990_2023.png",
...
print(p_nat_total)
ggsave("nowcast_yearly_barplot_NATIONAL_TOTAL.png",
...
ggsave("nowcast_yearly_barplot_NATIONAL_TOTAL_with_pred_band.png",
