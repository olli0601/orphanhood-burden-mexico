...
population_df <- readRDS("../datasets/population_new_mun.RDS")
...
#------------------------- FERTILITY DATASET ------------------------------
# ---------- PER AGE BAND GROUP
fr_df <- readRDS("../datasets/fert.RDS") |> 
  filter(year >= 1990) |>
...
#--------- FOR EACH YEAR 
fertility_df <- readRDS("../datasets/births_long.RDS")
...
#--------------------------- DEATHS DATASET ------------------------------
deaths_df <- readRDS("../datasets/deaths.RDS") |>
  filter(year >= 1990)
...
#------------------------- SURVIVAL DATASET ------------------------------
mort_df <- readRDS("../datasets/mort_df.RDS")
...
#---------------------- HAZARD 5 YEARS -------------------------
deaths_single <- readRDS("../datasets/deaths_df_long.RDS")
...
deaths <- readRDS("../datasets/mort.RDS") |>
