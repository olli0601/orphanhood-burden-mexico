...
validation_preds <- readRDS('../validation_predictions.RDS')
test_preds <- readRDS('../test_predictions.RDS')
validation_metrics <- readRDS('../validation_metrics.RDS')
...
ggsave("model_fixes_comparison.png", p_comparison, width = 12, height = 6, dpi = 300, bg = "white")
...
saveRDS(validation_preds_final, "validation_predictions_corrected.RDS")
saveRDS(test_preds_final, "test_predictions_corrected.RDS")
saveRDS(final_val_metrics, "validation_metrics_corrected.RDS")
saveRDS(final_test_metrics, "test_metrics_corrected.RDS")
saveRDS(problematic_municipalities, "problematic_municipalities.RDS")
...
saveRDS(correction_summary, "model_corrections_summary.RDS")
